...
A [forgery attack](attack-trees:docs/crypto/Forgery-attack) can be mounted by an [E2EE adversary](../adversaries/E2EE-adversary.md), able to bypass the client-to-server transport encryption.
